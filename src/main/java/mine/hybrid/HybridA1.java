...
public class HybridA1 extends Algorithm {
	...
	protected HybridA1( String rulefile, String Rfile, String Sfile ) throws IOException {
		...
		for( int i = 0; i < tableR.size(); ++i ) {
			...
			for( Record expR : expanded ) {
				if( !setR.containsKey( expR ) )
					setR.put( expR, new ArrayList<Integer>() );
	...
	private int searchEquivsByDynamicIndex( Record s, Map<IntegerPair, List<IntIntRecordTriple>> idx, Set<IntegerPair> rslt ) {
