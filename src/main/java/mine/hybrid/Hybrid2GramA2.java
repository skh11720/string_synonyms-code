 ...
 */
public class Hybrid2GramA2 extends Algorithm {
	...
	protected Hybrid2GramA2( String rulefile, String Rfile, String Sfile ) throws IOException {
	...
	public static void main( String[] args ) throws IOException {
		...
		long startTime = System.currentTimeMillis();
		Hybrid2GramA2 inst = new Hybrid2GramA2( Rulefile, Rfile, Sfile );
