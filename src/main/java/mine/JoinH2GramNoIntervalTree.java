...
public class JoinH2GramNoIntervalTree extends Algorithm {
	...
	public JoinH2GramNoIntervalTree( String rulefile, String Rfile, String Sfile ) throws IOException {
	...
	public static void main( String[] args ) throws IOException {
		...
		JoinH2GramNoIntervalTree inst = new JoinH2GramNoIntervalTree( Rulefile, Rfile, Sfile );
