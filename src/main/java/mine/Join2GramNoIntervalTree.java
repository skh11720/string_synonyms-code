...
public class Join2GramNoIntervalTree extends Algorithm {
	...
	protected Join2GramNoIntervalTree( String rulefile, String Rfile, String Sfile ) throws IOException {
	...
	private WYK_HashSet<IntegerPair> join() {
		...
		if( skipChecking )
			System.out.println( "Candidates : " + comparisons );
	...
	public static void main( String[] args ) throws IOException {
		...
		long startTime = System.currentTimeMillis();
		Join2GramNoIntervalTree inst = new Join2GramNoIntervalTree( Rulefile, Rfile, Sfile );
