...
public class JoinMin_QL extends AlgorithmTemplate {
	...
	public JoinMin_QL( String rulefile, String Rfile, String Sfile, String outputFile, DataInfo dataInfo, boolean joinOneSide,
	...
	public JoinMin_QL( AlgorithmTemplate o, StatContainer stat ) {
		super( o );
