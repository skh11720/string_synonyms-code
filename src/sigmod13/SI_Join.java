...
public class SI_Join extends SIAlgorithm {
	...
	public SI_Join( String DBR_file, String DBS_file, String rulefile ) throws IOException {
	...
	public void join( SI_Tree<SIRecord> treeR, SI_Tree<SIRecord> treeS, double threshold ) {
		long startTime = System.currentTimeMillis();
	...
	private static void printUsage() {
		System.out.println( "Usage : <R file> <S file> <Rule file> <Threshold> <Filter No.> [T=exact]" );
	}
}
