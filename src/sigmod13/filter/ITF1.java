...
public class ITF1 extends ITF_Filter {
  private IntegerMap<Long> tf_Record;
  private IntegerMap<Long> tf_Rule;

  public ITF1(ArrayList<SIRecord> records, ArrayList<Rule> rules) {
    super(records, rules);
  ...
  @Override
  /*
   * Precedence priority: 1) Tokens from the record 2) Less ITF value
   */
