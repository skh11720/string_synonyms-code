...
public class Hybrid2GramWithOptTheta5 extends Algorithm {
  ...
  protected Hybrid2GramWithOptTheta5(String rulefile, String Rfile,
  ...
  private void estNaiveExecTime() {
    ...
    for (Record s : tableR) {
      ...
      if (expanded != currexpanded) currexpanded = expanded;
  ...
  public static void main(String[] args) throws IOException {
    ...
    long startTime = System.currentTimeMillis();
    Hybrid2GramWithOptTheta5 inst = new Hybrid2GramWithOptTheta5(Rulefile,
        Rfile, Sfile);
