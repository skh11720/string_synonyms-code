...
for SIZE in ${SIZES[@]};
do
	./setPrunedAOL.sh $SIZE

	project=aol_pruned_$SIZE
	inputfile_one=data_store/aol/pruned/aol_pruned_$SIZE\_data.txt
	inputfile_two=data_store/aol/pruned/aol_pruned_$SIZE\_data.txt
