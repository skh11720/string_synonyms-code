...
public class QGramGlobalOrder extends AbstractGlobalOrder<QGram> {
	...
	public int compare( int[] qgram1, int[] qgram2 ) {
		...
		case FF: return Integer.compare( orderMap.getInt(new QGram(qgram1)), orderMap.getInt(new QGram(qgram2)) );
		default: throw new RuntimeException("Unexpected error");
		}
	}
