...
import snu.kdd.synonym.synonymRev.index.JoinMinPositionIndex;
...
public class JoinMinPosition extends AlgorithmTemplate {
	public int qSize = 0;
	public int indexK = 0;
	 ...
	 */
	public JoinMinPositionIndex idx;

	public JoinMinPosition( Query query, StatContainer stat ) throws IOException {
		super( query, stat );
	}
	...
	private void buildIndex( boolean writeResult ) throws IOException {
		idx = new JoinMinPositionIndex( indexK, qSize, stat, query, writeResult );
	}
