...
//			}
		...
		buildIndex( query.indexedSet, query.searchedSet );
		if ( !query.selfJoin ) buildIndex( query.searchedSet, query.indexedSet );
...
//			}
	...
	protected void buildIndex( Dataset searchedSet, Dataset indexedSet ) {
...
//			System.out.println( rec.getID()+"\t"+recOther.getID()+"\t"+recCount+"\t"+idxCount.getInt( recOther ) );
